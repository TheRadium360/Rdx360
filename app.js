...
//! Defining our template-view engine 
app.set('view engine', 'pug');
app.set('views', path.join(__dirname, 'views')) // telling express where our views are located



//Optimize:                    ************** Global Midle-Wares ***************
// ! Middleware for static files
app.use(express.static(path.join(__dirname, 'public'))); // default root
